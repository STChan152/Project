...
<section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="singincodeT.php" method="post" role="form" class="php-email-form">
            <div class="form-group"><strong> รหัสอาจารย์</strong>
                <input type="text" class="form-control" name="AdvisorID" id="AdvisorID"  />
                <div class="validate"></div>
              </div>
              <div class="form-row">
                <div class="col form-group"> <strong> Username</strong>
                <input type="text" class="form-control" name="Username" id="Username"  data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                  <div class="validate"></div>
                </div>
                <div class="col form-group"> <strong> Password </strong>
                  <input type="password" class="form-control" name="Password1" id="Password1"  data-rule="Password" data-msg="Please enter at least 8 chars " />
                  <div class="validate"></div>
                </div>
              </div>
              <div class="form-row">
                ...
                <div class="col form-group"> <strong> นามสกุล</strong>
                  <input type="text" class="form-control" name="S_Name" id="S_Name" data-rule="text" data-msg="Please enter at least 1 chars" />
                  <div class="validate"></div>
                </div>
              </div>
              ...
              <div class="form-group"><strong> อีเมล์</strong>
              ...
              <div class="form-group"><strong>เบอร์ติดต่อ </strong>
                <input type="int" class="form-control" name="Tel" id="Tel" data-rule="minlen:4" data-msg="Please enter at least 10 chars of subject" />
                <div class="validate"></div>
              </div>
