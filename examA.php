...
<table>
  ...
  <th><center>ลำดับ</center></th>
    ...
    <th><center>อาจารย์ทีปรึกษา</center></th>
  ...
  <td><input type="text" name="id" class="form-control" id="id" ></td>
    <td><input type="text" name="P_title" class="form-control" id="P_title" ></td>
    <td><input type="text" name="StdentID" class="form-control" id="StdentID" ></td>
    <td><center><input type="text" name="Date1" class="form-control" id="Date"  ></center></td>
    <td><center><input type="text" name="Time1" class="form-control" id="Time"  ></center></td>
    <td><center><input type="text" name="Room" class="form-control" id="Room" ></center></td>
    <td><input type="text" name="AName" class="form-control" id="AName" ></td>
    <td><input type="text" name="AName1" class="form-control" id="AName1" ></td>
    <td><input type="text" name="AName2" class="form-control" id="AName2" ></td>
    <td><input type="text" name="AName3" class="form-control" id="AName3" ></td>
    <div class="mb-3">
  ...
  <?php
                          ...
                          echo "<td><center>".$row["AName"]."</center></td>";
                          echo "<td><center>".$row["AName1"]."</center></td>";
                          echo "<td><center>".$row["AName2"]."</center></td>";
                          echo "<td><center>".$row["AName3"]."</center></td>";
                          echo "<td><center><a href='delete.php?id=$row[id]' onclick=\"return confirm('คุณต้องการลบใช่หรือไม่')\">ลบข้อมูล</a>/<a href='editE.php?id=$row[id]' onclick=\"return confirm('คุณต้องการแก้ไขใช่หรือไม่')\">แก้ไข</a></center></td> ";
                          echo "</tr>";
                              }
                              } else {
                                  echo "ไม่มีข้อมูล";
