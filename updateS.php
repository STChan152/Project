...
<table>
  ...
  <?php
                          ...
                          echo "<td><center>".$row["S_Name"]."</center></td>";
                          echo "<td><center>".$row["Tel"]."</center></td>";
                          echo "<td><center>".$row["Email"]."</center></td>";
                          echo "<td><center>".$row["Username"]."</center></td>";
                          echo "<td><center>".$row["Password1"]."</center></td>";
                          echo "<td><center>".$row["Major"]."</center></td>";
                          
                          echo "<td><center><a href='deleteS.php?id=$row[id]' onclick=\"return confirm('คุณต้องการลบใช่หรือไม่')\">ลบข้อมูล</a>/<a href='editPS.php?id=$row[id]' onclick=\"return confirm('คุณต้องการแก้ไขใช่หรือไม่')\">แก้ไข</a></center></td> ";
                          echo "</tr>";
                              }
                              } else {
                                  echo "ไม่มีข้อมูล";
