...
<table>
  ...
  <tr>
  <form action="StatusEA.php" method="post" role="form" >
  <td><input type="text" name="id" class="form-control" id="id" ></td>
    ...
    <td><input type="text" name="StatusS" class="form-control" id="StatusS"  ></td>
  ...
  <?php
                          ...
                          echo "<td><center><a href='StatuSA.php?id=$row[id]' onclick=\"return confirm('คุณต้องการแก้ไขใช่หรือไม่')\">แก้ไข</a></center></td> ";
                          echo "</tr>";
                              }
                              } else {
                                  echo "ไม่มีข้อมูล";
