...
<div class="table1">
  <div class="bd-example">
    <table class="table">
      <thead>
          <tr>
            <th scope="col-3">รหัสอาจาย์</th>
            <th scope="col-3">ชื่อ-นามสกุล</th>
            <th scope="col-3">username</th>
            <th scope="col-3">password</th>
            <th scope="col-1">เบอร์โทรศัพท์</th>
            <th scope="col-1">อีเมล</th>
            <th scope="col-1">จัดการข้อมูลผู้ใช้</th>
          </tr>
        </thead>
                        <!-- <?php
                        ...
                        // output data of each row
                            while($row = $result->fetch_assoc()) {
                              ...
                              echo "<td><a href='delete-table-s.php?student_id=$row[student_id]' onclick=\"return confirm('คุณต้องการลบใช่หรือไม่')\">ลบข้อมูลผู้ใช้</a></td> ";
                              echo "</tr>";
                            }
                            } else {
                                echo "0 results";
