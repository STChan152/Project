...
<table>
  ...
  <?php
                          ...
                          echo "<td><center><a href='deleteT.php?id=$row[id]' onclick=\"return confirm('คุณต้องการลบใช่หรือไม่')\">ลบข้อมูล</a>/<a href='editPT.php?id=$row[id]' onclick=\"return confirm('คุณต้องการแก้ไขใช่หรือไม่')\">แก้ไข</a></center></td> ";
                          echo "</tr>";
                              }
                              } else {
                                  echo "ไม่มีข้อมูล";
