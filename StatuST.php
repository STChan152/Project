  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href="tech.php">บริการ</a></li>
          <li>ตารางสอบ</li>
        </ol>
        <h2>บริการ</h2>
...
<?php
          ...
          $sID = $_GET['id'];
          include 'connect.php';
          $show_edit = " select * from  Statuss where id='$sID'";
...
<table>
  ...
  <th><center>ลำดับ</center></th>
    ...
    <th><center>สถานนะ</center></th>
  
    <th><center></center></th>
    
    </tr>
  <tr>
  <form action="StatusTcode.php" method="post" role="form" >
  <td><input type="text" name="id" class="form-control" id="id" value="<?php echo $rec['id']; ?>"></td>
    ...
    <td><input type="text" name="StatusS" class="form-control" id="StatusS"  value="<?php echo $rec['StatusS']; ?>"></td>
  ...
  <?php
                        ...
                        //   echo "<td><center>".$row["StatusS"]."</center></td>";
                     
                        //   echo "<td><center><a href='StatusAcode.php?id=$row[id]' onclick=\"return confirm('คุณต้องการแก้ไขใช่หรือไม่')\">แก้ไข</a></center></td> ";
                        //   echo "</tr>";
                        //       }
                        //       } else {
                        //           echo "ไม่มีข้อมูล";
