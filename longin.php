    ...
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="blog.copy.php">บอร์ด</a></li>
          <li><a href="contact.copy.html">ติดต่อ</a></li>
      ...
      <div class="container">
        ...
        <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="loginA.php">ผู้ดูแลระบบ</a></h4>
          ...
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="loginT.php">อาจารย์</a></h4>
               <!-- <p> นักศึกษาทำการ ยื่นเอกสารขอสอบ ทั้งหัวข้อ /สอบโปรเจ็ค</p>  -->
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="loginS.php">นักศึกษา</a></h4>
