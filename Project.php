  ...
  <section id="contact" class="contact">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8">
          <form action="projectcode.php" method="post" role="form" class="php-email-form">
                <div class="form-row">
                  <div class="col form-group">
                    <strong>ชื่อโปรเจค</strong>
                    <textarea type="text" class="form-control" name="P_titel" rows="1" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                </div>
                  <div class="form-group">
                  <strong>ประเภทโครงงาน</strong>
                    <textarea type="text" class="form-control" name="Type" rows="1" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  <strong>ที่มาและความสำคัญ</strong>
                    <textarea type="text"class="form-control" name="Origin" rows="5" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  <strong>ขอบเขตของโครงงาน</strong>
                    <textarea type="text" class="form-control" name="Scope" rows="5" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  <strong>วัตถุประสงค์ของโครงงาน</strong>
                    <textarea type="text" class="form-control" name="Objective" rows="5" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                  <div class="form-group">
                  <strong>เครื่องมือที่ใช้พัฒนา</strong>
                    <textarea type="text" class="form-control" name="Tool" rows="5" data-rule="required" data-msg="Please write something for us" ></textarea>
                    <div class="validate"></div>
                  </div>
                  <div class="mb-3">
                ...
                <div class="text-center"><button type="submit">ยื่นหัวข้อสอบ</button></div>
              </form>
        </div>
        <div class="col-lg-2"></div>
      </div>
