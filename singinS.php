    ...
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <!-- <li class="active"><a href="services.html">บริการ</a></li> -->
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
        <li><a href="Sutuden.php">นักศึกษา</a></li>
          <li>สมัครสมาชิก</li>
        </ol>
        <h2>สมัครสมาชิก</h2>
...
<section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <form action="singincodeS.php" method="post" role="form" class="php-email-form">
            <div class="form-group"><strong> รหัสนักศึกษา</strong>
                <input type="text" class="form-control" name="StdentID" id="StdentID"  data-rule="minlen:4" data-msg="Please enter at least 11 chars " />
                <div class="validate"></div>
              </div>
              <div class="form-row">
                <div class="col form-group"> <strong> Username</strong>
                  <input type="text" name="Username" class="form-control" id="Username"  data-rule="minlen:4" data-msg="Please enter at least 8 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col form-group"> <strong> Password </strong>
                  <input type="password" class="form-control" name="Password1" id="Password1
                  "  data-rule="Password" data-msg="Please enter at least 8 chars " />
                  <div class="validate"></div>
                </div>
              </div>
              <div class="form-row">
                <div class="col form-group"> <strong> ชื่อ</strong>
                  <input type="text" name="F_Name" class="form-control" id="F_Name"  data-rule="minlen:4" data-msg="Please enter at least 1 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col form-group"> <strong> นามสกุล</strong>
                  <input type="text" class="form-control" name="S_Name" id="S_Name" data-rule="minlen:4" data-msg="Please enter at least 1 chars" />
                  <div class="validate"></div>
                </div>
              </div>
              <!-- <div class="form-group"><strong> สาขา</strong>
              ...
              <div class=" col-md-12">
                <select name="Major" id="Major" class="form-control">
                  <option selected>เทคโนโลยีสารสนเทศ</option>
              ...
              <div class="form-group"><strong>เบอร์ติดต่อ </strong>
                <input type="int" class="form-control" name="Tel" id="Tel" data-rule="minlen:4" data-msg="Please enter at least 10 chars  " />
                <div class="validate"></div>
              </div>
              <div class="form-group"><strong></strong> <br>
              <font color="red"> *กรุณากรอกให้ครบทุกช่อง</font> 
                <div class="validate"></div>
              </div>
              <div class="mb-3">
                <div class="loading">Loading</div>
                <div class="error-message"></div>
                <div class="sent-message">คุณได้สมัครเข้าใช้งานระบบ </div>
              </div>
              <div class="text-center"><button type="submit">สมัครใช้งาน</button></div>
            </form>
          </div>
          <div class="col-lg-3"></div>
        </div>
