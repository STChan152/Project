...
<body>
  ...
  <section id="login">
    ...
    <div class="container">
            <form action="logincodeT.php" method="post" style=" display: grid;justify-content: center;padding: 20px;width: 400px; border-radius: 5px;box-shadow: 0 0 30px rgba(214, 215, 216, 0.6); " >
              ...
              <input type="password" id="Password1" name="Password1" style="width: 300px;background: #efefef;border: 1px solid#a7a7a7;height: 35px;border-radius: 5px;" ><br>
