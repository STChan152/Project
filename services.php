        ...
        <div class="row">
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="SubmitD.php">ยื่นขอสอบ</a></h4>
               <!-- <p> นักศึกษาทำการ ยื่นเอกสารขอสอบ ทั้งหัวข้อ /สอบโปรเจ็ค</p>  -->
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="exam.php">ตารางสอบ</a></h4>
               <!-- <p>อาจารย์ / นักศึกษาาสามารถดูตารางสอบ หัวข้อโปรเจค</p> -->
          ...
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-lg-4">
            <div class="icon-box">
              ...
              <h4><a href="result.php">ตรวจสอบผลสอบ</a></h4>
              <!-- <p><br<br> อาจารย์ / นักศึกษาสามารถตรวจผลสอบหัวข้อโปรเจค /โปรเจค</p> -->
            </div>
          </div>
          <div class="col-lg-2 col-md-6 align-items-stretch mt-4 mt-lg-4">
          </div>
          <div class="col-lg-4 col-md-6 align-items-stretch mt-4 mt-lg-4">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="uplond.php">อัพโหลดเอกสาร</a></h4>
          ...
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-lg-4">      
            <div class="icon-box">
              ...
              <h4><a href="blog.php">ตัวอย่างโครงงานนักศึกษา</a></h4>
              <!-- <p><br<br> ตัวอย่างโครงานนักศึกษาที่นักศึกษาและอาจารย์หรือผู้ที่สนใจสามารถเข้าไปดูได้ </p> -->
            </div>
          </div>
          <div class="col-lg-2 col-md-6 align-items-stretch mt-4 mt-lg-4">
