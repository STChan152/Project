    ...
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <!-- <li class="active"><a href="PinforT.php">ข้อมูลส่วนตัว</a></li> -->
          <li class="active"><a href="tech.php">บริการ</a></li>
        
          <li><a href="blogT.php">บอร์ด</a></li>
          <li><a href="CONtact.T.html">ติดต่อ</a></li>
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
             
              <h4><a href="filedT.php">เอกสารที่นักศึกษายื่น</a></h4>
               <p> </p> 
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-md-4">
            <div class="icon-box">
              ...
              <h4><a href="examT.php">ตารางสอบ</a></h4>
               <p></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-lg-4">
            <div class="icon-box">
              ...
              <h4><a href="SatatusT.php">ส่งผลสอบ</a></h4>
              <p><br<br> </p>
            </div>
          </div>
          ...
          <!-- <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="uplond.html">อัพโหลดเอกสาร</a></h4>
              <p><br<br> นักศึกษาสามารถทำการอัพโหลดไฟล์เอกสารโปรเจคทั้งหมด เพื่อให้น้องๆ เพื่อนๆเข้ามาดูเป็นตัวอย่างได้</p>
            </div>
          </div> -->
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-lg-4">      
            <div class="">
          ...
          <div class="col-lg-4 col-md-6  align-items-stretch mt-4 mt-lg-4">      
            <div class="icon-box">
              ...
              <h4><a href="blogT.php">ตัวอย่างโครงงานนักศึกษา</a></h4>
              <p><br<br> </p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="tech.php">บริการ</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="blogT.php">ตัวอย่างโครงการ</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="CONtact.T.html">ติดต่อเรา</a></li>
            </ul>
          </div>
